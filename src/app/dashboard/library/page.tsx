...
/**
 * Studio Empty-State (rechte Spalte wenn kein Creative gewählt).
 * Die Liste links wird vom Layout geliefert.
 */
  ...
  return (
    <div className="mx-auto max-w-md py-16 text-center">
      ...
      <p className="mt-2 text-[13px] leading-relaxed text-[var(--color-muted)]">
        Klick in der Liste links auf ein Creative, um es zu bearbeiten, zu
